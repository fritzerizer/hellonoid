    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          <div className="flex items-center">
            <div className="flex-shrink-0 w-12 h-12 bg-[#239eab]/20 rounded-lg flex items-center justify-center">
              <Icon name="robot" className="text-[#239eab] text-xl" />
            </div>
            <div className="ml-4">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          <div className="flex items-center">
            <div className="flex-shrink-0 w-12 h-12 bg-[#239eab]/20 rounded-lg flex items-center justify-center">
              <Icon name="newspaper" className="text-[#239eab] text-xl" />
            </div>
            <div className="ml-4">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          <div className="flex items-center">
            <div className="flex-shrink-0 w-12 h-12 bg-[#239eab]/20 rounded-lg flex items-center justify-center">
              <Icon name="clock" className="text-[#239eab] text-xl" />
            </div>
            <div className="ml-4">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          <div className="space-y-3">
            <p className="text-gray-300 flex items-center gap-2">
              <Icon name="envelope" className="text-gray-500 w-4" />
              <span className="text-gray-400">Email:</span> {profile.email}
            </p>
            <p className="text-gray-300 flex items-center gap-2">
              <Icon name="shield-halved" className="text-gray-500 w-4" />
            ...
            <p className="text-gray-300 flex items-center gap-2">
              <Icon name="calendar-day" className="text-gray-500 w-4" />
