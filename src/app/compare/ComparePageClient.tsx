...
export default function ComparePageClient({ robots, entities, robotSpecs }: Props) {
              ...
              <tr className="border-b border-[#222] bg-[#111]">
                ...
                {selectedRobots.map(r => (
                  <th key={r.id} className="p-3 text-left font-medium">
                    ...
                    <div className="text-xs text-[#666] font-normal">{entities.find(e => e.id === r.entity_id)?.name}</div>
                  </th>
                ))}
              </tr>
            </thead>
